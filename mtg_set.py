...
class SetInfo:
#
    longname: str #'Actually Apeshit Aligators'
    name: str # 'AAA'
    type: str
    size: int
    version: str = '0.0.0'
...
#
    ...
    ability : str = ''
    pt : str = None # these tags can be omited from the data base so having them throw an error if accessed without a failure case is a hint.
    loyalty : str = None # these tags can be omited from the data base so having them throw an error if accessed without a failure case is a hint.
    set_code: str = 'AAA'
    ...
    # Used to sort an iterable object into a string that follows the order of CWUBRG. This should be used to clean up any color based data that will be used for the database.
        sorted_colors = ''
